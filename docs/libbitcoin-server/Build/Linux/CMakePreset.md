...
The libbitcoin-server library can be build either dynamic or static.
...
```
./install-cmakepresets.sh --build-dir=/home/user/libbitcoin-server/  --prefix=/home/user/libbitcoin-server/prefix/nix-gnu-debug-shared --preset=nix-gnu-debug-shared --disable-static --disable-ndebug -Denable-ndebug=no  --build-boost  --build-secp256k1
```
...
```
./install-cmakepresets.sh --build-dir=/home/user/libbitcoin-server/  --prefix=/home/user/libbitcoin-server/prefix/nix-gnu-release-static --preset=nix-gnu-release-static --disable-shared --enable-ndebug -Denable-ndebug=yes  --build-boost --build-icu --with-icu --build-secp256k1
```
