...
```
./install-cmake.sh --build-dir=/home/user/libbitcoin-server/  --prefix=/home/user/libbitcoin-server/prefix --disable-static --disable-ndebug -Denable-ndebug=no  --build-boost  --build-secp256k1
```
...
```
./install-cmake.sh --build-dir=/home/user/libbitcoin-server/  --prefix=/home/user/libbitcoin-server/prefix --disable-shared --enable-ndebug -Denable-ndebug=yes  --build-boost --build-icu --with-icu --build-secp256k1
```
