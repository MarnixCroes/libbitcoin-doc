...
```
./install-cmake.sh --build-dir=/home/user/libbitcoin-server/  --prefix=/home/user/libbitcoin-server/prefix --disable-shared --enable-ndebug -Denable-ndebug=yes  --build-boost --build-secp256k1
```
