...
```
./install.sh --build-dir=/home/user/libbitcoin-server/ --enable-isystem --prefix=/home/user/libbitcoin-server/prefix --disable-shared --enable-ndebug  --build-boost --build-icu --with-icu --build-secp256k1
```
