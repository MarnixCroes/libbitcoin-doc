...
```
./install-cmake.sh --build-dir=/Users/libbitcoin-server/  --prefix=/Users/libbitcoin-server/prefix --disable-static --enable-ndebug -Denable-ndebug=yes  --build-boost  --build-secp256k1
```
...
```
./install-cmake.sh --build-dir=/Users/libbitcoin-server/  --prefix=/Users/libbitcoin-server/prefix --disable-shared --enable-ndebug -Denable-ndebug=yes  --build-boost  --build-secp256k1
```
