...
```
./install.sh --build-dir=/Users/libbitcoin-server/ --enable-isystem --prefix=/Users/libbitcoin-server/prefix --disable-static --enable-ndebug  --build-boost  --build-secp256k1
```
...
```
./install.sh --build-dir=/Users/libbitcoin-server/ --enable-isystem --prefix=/Users/libbitcoin-server/prefix --disable-shared --enable-ndebug  --build-boost  --build-secp256k1
```
