...
```
./install-cmakepresets.sh --build-dir=/home/user/libbitcoin-system/ -Denable-avx2=on -Denable-sse41=on --prefix=/home/user/libbitcoin-system/prefix/nix-gnu-debug-shared --preset=nix-gnu-debug-shared --disable-static --disable-ndebug -Denable-ndebug=no  --build-boost  --build-secp256k1
```
