...
```
./install-cmake.sh --build-dir=/home/user/libbitcoin-system/ -Denable-avx2=on --prefix=/home/user/libbitcoin-system/prefix --disable-shared --enable-ndebug -Denable-ndebug=yes  --build-boost --build-secp256k1
```
