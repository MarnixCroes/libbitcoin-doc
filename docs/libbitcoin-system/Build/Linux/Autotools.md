...
```
./install.sh --build-dir=/home/user/libbitcoin-system/ --enable-isystem --enable-avx2 --prefix=/home/user/libbitcoin-system/prefix --disable-shared --enable-ndebug  --build-boost --build-secp256k1
```
