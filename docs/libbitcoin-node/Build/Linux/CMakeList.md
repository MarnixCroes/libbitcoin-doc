...
```
./install-cmake.sh --build-dir=/home/user/libbitcoin-node/  --prefix=/home/user/libbitcoin-node/prefix --disable-shared --enable-ndebug -Denable-ndebug=yes  --build-boost --build-secp256k1
```
