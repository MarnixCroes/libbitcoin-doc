...
```
./install-cmakepresets.sh --build-dir=/home/user/libbitcoin-network/  --prefix=/home/user/libbitcoin-network/prefix/nix-gnu-release-static --preset=nix-gnu-release-static --disable-shared --enable-ndebug -Denable-ndebug=yes  --build-boost --build-secp256k1
```
